...
<template>
    <section id="hero-section" class="bg-gradient-to-br from-purple-700 to-pink-500 flex-1">
        <div id="hero-container" class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
            ...
            <div id="hero-image-container" class="hidden lg:mt-0 lg:col-span-5 lg:flex items-center justify-center">
                <img id="hero-image" src="./images/hero.png" alt="hero image" class="rounded-full border-4 border-pink-300 shadow-lg transform hover:scale-105 transition duration-300 ease-in-out">
            </div>
        </div>
    </section>
</template>
